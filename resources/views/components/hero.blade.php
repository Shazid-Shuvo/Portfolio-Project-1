            ...
            <div class="col-xxl-5">
                <div class="text-center text-xxl-start">
                    <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                        <div class="text-uppercase" id="keyLine">
                            Design &middot; Development &middot; Marketing
                        </div>
                    </div>
                    <div class="fs-3 fw-light text-muted" id="short_title">
                        I can help your business to
                    </div>
                    <h1 class="display-3 fw-bolder mb-5">
                        <span class="text-gradient d-inline" id="title">
...
<script>
    ...
    async function getHero() {
        ...
        try {
            ...
            document.getElementById('short_title').innerHTML=response.data['title'];
            document.getElementById('title').innerHTML=response.data['shortTitle'];
